...
class DatabaseManager:
    ...
    def _load_env_config(self):
        ...
        if not is_docker:
            ...
            self.logger.info("Docker环境检测到，使用环境变量配置")
        ...
        # Debug logging
        self.logger.info(f"[DEBUG] Raw env vars: MONGODB_HOST={mongodb_host}, REDIS_HOST={redis_host}, REDIS_PORT={redis_port}")
